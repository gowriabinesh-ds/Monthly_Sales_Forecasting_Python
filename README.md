...
| Final Forecast Plot (BU2 Example) |
| :---: |
| **[INSERT IMAGE HERE: Plot showing the fitted ARIMA(0,1,1) model for BU2 with the forecast for Jan, Feb, and Mar 2018 and its confidence interval]** |
| *Caption: The 3-month forecast generated by the ARIMA(0,1,1) model for BU2, including the 95% confidence bounds.* |
